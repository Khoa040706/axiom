...
{
    public class frmHRDashboard : Form
    {
        public frmHRDashboard()
        {
            this.Text = "HRM & Payroll – HR Manager Dashboard";
            ...
            var lbl = new Label
            {
                Text      = $"Xin chào, {AppSession.CurrentUser?.FullName ?? "HR Manager"}!\nĐây là trang HR Dashboard.",
